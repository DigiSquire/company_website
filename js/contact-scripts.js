       ...
       /* Mobile Navigation Hide or Collapse on Click */
        ...
        $('.statistics').appear(function() {
         ...
         $('#my-address').gMap({
            ...
            markers:[
            {
            address: "Neco Skypark, Matoshri Colony, Nandanwan Society, Ingawale Nagar, Vishal Nagar, Pimpri-Chinchwad, Maharashtra 411027",  /* You can change your address from here */
            html: "<b>Address</b>: <br>Neco Skypark",   /* You can change display address text from here */
            popup: true
            }
            ]
            });
